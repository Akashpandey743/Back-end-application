...
app.get("/", (req, res) => {
  //Step 1 - Make the get route work and render the index.ejs
...
app.post("/submit", (req, res) => {
  ...
  const randomName = adj[Math.floor(Math.random()*(10)*(adjLength))] + noun[Math.floor(Math.random()*(10)*(nounLengthLength))]
  
  res.render('index.ejs',{data:randomName})

});

app.listen(port, () => {
  console.log(`Listening serverr on port ${port}`);
});
